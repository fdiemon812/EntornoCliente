...
function enviarFormulario(ev){
    ...
    if(Object.values(formularioValido).indexOf(false)==-1){
        ...
        peticion.send(JSON.stringify(objetoUsuario))
...
function consultaDatos(ev){
    ...
    //FALTA ARREGLAR ESTA ÚLTIMA LINEA PARA QUE FUNCIONE
    let usuarioListar= JSON.parse(peticion2)
        //Falta obtener los datos de la peticion, parsearlos a un array y repetir el proceso de la tabla.
    //console.log(JSON.parse(peticion2))
